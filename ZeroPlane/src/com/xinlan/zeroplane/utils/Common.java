...
public class Common {
	...
	public static boolean isRectFHit(RectF rectSrc, RectF dst) {
		return isHit(rectSrc.left, rectSrc.top, rectSrc.width(),
				rectSrc.height(), dst.left, dst.top, dst.width(), dst.height());
	}
